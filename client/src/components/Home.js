    ...
    websiteInfo && Object.keys(websiteInfo).length === 0 ? null :
        <div className="home">
            ...
            <div className="productDescription">
                ...
                <div>
                    {websiteInfo.message}
                    {/* We take dessert delivery to another level! Have the perfect desserts delivered straight to your doorstep with a 100% customer satisfaction guarantee. Frozen or freshly baked we supply the best desserts that money can buy. Order online and have your order at your doorstep within 48 hours anywhere in Canada. All Orders are specially refrigerated to keep it as fresh as when it was first made. */}
